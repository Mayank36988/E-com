  ...
  return (
    <div className="min-h-screen flex">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://media.istockphoto.com/id/1347626309/photo/latina-female-using-desktop-computer-with-clothing-online-web-store-to-choose-and-buy-clothes.jpg?s=1024x1024&w=is&k=20&c=Ow6Tnb6XkEARWwdxbXDe2SpkodV5ctxyJsQw7pzASZU=')",
        }}
      ></div>
        ...
        <div className="w-full max-w-md p-8 space-y-6">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full py-2 px-4 bg-green-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                disabled={isLoading} // Disable button when loading
              >
                {isLoading ? "Logging in..." : "Log in"}
              </button>
