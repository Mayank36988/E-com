...
router.get("/subcategories/category/:catid", authenticate, getSubCategoriesByCategoryId); 
router.get("/subcategories/search/:categoryName", authenticate, getSubCategoriesByCategoryName); 
