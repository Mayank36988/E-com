...
router.get("/user/:user_id", authenticate, adminUserProfileController.getProfileByUserId);
...
router.post("/", authenticate, adminUserProfileController.createProfile);

// Update profile
router.put("/:profile_id", authenticate, adminUserProfileController.updateProfile);

// Delete profile
router.delete("/:profile_id", authenticate, adminUserProfileController.deleteProfile);
